...
public class SyncAtomicDemo {
    ...
    public static void main(String args[]) {
        SyncAtomicDemo demo = new SyncAtomicDemo();
        demo.setUp();
...
//                    System.out.print((result1 ? "+" : "-") + " ");
        ...
        private boolean transfer(Account fromAccount, Account toAccount, int transferAmount) {
            ...
            while (true){
                ...
                int currentBalance = fromAccount.getUpdater().get(fromAccount);
                ...
                if (transferAmount> currentBalance){
                    ...
                    fromAccount.getUpdater().compareAndSet(fromAccount,currentBalance, currentBalance-transferAmount);
                    break;
                }
            }
            if (withdrawOk){
                toAccount.getUpdater().getAndAdd(toAccount, transferAmount);
            }
            return withdrawOk;
        }
    }
